            ...
            <div class="col-md-9">
                ...
                <div class="panel panel-info">
                    ...
                    <div class='panel-info panel-description'>
                        <?php echo trans($plang_admin.'.description.task-list'); ?></h4>
                    </div>
                    <!--/DESCRIPTION-->
                    ...
                    <div class="panel-body">
                        <?php echo Form::open(['route'=>['task.delete', 'id' => @$item->id], 'method' => 'get']); ?>
                            ...
                            <?php echo $__env->make('package-task::admin.task-item', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('package-acl::admin.layouts.base-2cols', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/project-task/vendor/foostart/package-task/Views/admin/task-items.blade.php ENDPATH**/ ?>