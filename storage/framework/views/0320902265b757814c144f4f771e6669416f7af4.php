<div class="row">
    <div class="col-md-8">
        <div class="crop-container">
            <img src="<?php echo e($img->url . '?timestamp=' . $img->updated); ?>" class="img img-responsive">
        </div>
    </div>
    <div class="col-md-4">
        <div class="text-center">
            ...
            <button class="btn btn-primary"
                    onclick="performCrop()"><?php echo e(trans('package-filemanager::lfm.btn-crop')); ?></button>
            <button class="btn btn-primary"
                    onclick="performCropNew()"><?php echo e(trans('package-filemanager::lfm.btn-copy-crop')); ?></button>
            <button class="btn btn-info"
                    onclick="loadItems()"><?php echo e(trans('package-filemanager::lfm.btn-cancel')); ?></button>
            <form id='cropForm'>
...
<?php /**PATH /var/www/html/project-task/vendor/foostart/package-filemanager/src/views/crop.blade.php ENDPATH**/ ?>