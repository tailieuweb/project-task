        ...
        <div class="col-md-9">
            ...
            <div class="panel panel-info">
                ...
                <div class="panel-heading">
                    <h3 class="panel-title bariol-thin"><i class="fa fa-list-ul" aria-hidden="true"></i>
                        <?php echo $params ? trans($plang_admin.'.pages.title-list-search') : trans($plang_admin.'.pages.title-list'); ?>
            ...
            <!--/ERRORS-->
                ...
                <div class="panel-body">
                    <?php echo Form::open(['route'=>['categories.delete', 'id' => @$item->id], 'method' => 'get', 'class' => 'form-responsive']); ?>


                    <?php echo $__env->make('package-category::admin.category-item', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('package-acl::admin.layouts.base-2cols', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/project-task/vendor/foostart/package-category/Views/admin/category-items.blade.php ENDPATH**/ ?>