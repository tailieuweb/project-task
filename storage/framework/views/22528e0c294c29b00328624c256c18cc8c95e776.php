                ...
                <div class="panel panel-info">
                    ...
                    <div class="panel-heading">
                        <h3 class="panel-title bariol-thin"><i class="fa fa-list-ul" aria-hidden="true"></i>
                            <?php echo $request->all() ? trans($plang_admin.'.pages.title-list-search') : trans($plang_admin.'.pages.title-list-teachers'); ?>
                    ...
                    <div class='panel-info panel-description'>
                        <?php echo trans($plang_admin.'.description.list-teachers'); ?></h4>
                    </div>
                    <!--/DESCRIPTION-->
                    ...
                    <div class="panel-body">
                        <?php echo Form::open(['route'=>['task.delete', 'id' => @$item->id], 'method' => 'get']); ?>
                            ...
                            <?php echo $__env->make('package-task::teacher.task-item', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('package-acl::admin.layouts.base-2cols', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/project-task/vendor/foostart/package-task/Views/teacher/task-items.blade.php ENDPATH**/ ?>