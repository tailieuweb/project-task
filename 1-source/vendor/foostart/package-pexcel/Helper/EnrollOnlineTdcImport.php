...
use Foostart\Pexcel\Helper\User\EnrollImport;

class EnrollOnlineTdcImport implements ToCollection
{
    use Importable;
    public $item;
    ...
    public function collection(Collection $rows)
    {
        ...
        $userImport = new EnrollImport($this->item);
        $userImport->enrollUsers($studentInfo);
